...
<body>
    <fieldset>
        <legend class='h2'>Update request <img class='img-thumbnail rounded-circle' src='../pictures/<?php echo $picture ?>' alt="<?php echo $name ?>"><?php echo $name ?></legend>
        <form action="actions/a_update.php" method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>species</th>
                    <td><input class="form-control" type="text" name="species"   value="<?php echo $species ?>" /></td>
                </tr>
                <tr>
                    <th>Location</th>
                ...
                <td> <select name="status" value="<?php echo $status ?>">
                        ...
                        <option value="not avalible">Adopted</option>
                    </select>
                </td>
                </tr>
                <tr>

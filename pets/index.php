    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        <div class='card' style='width: 18rem;'>
            <img src='../pictures/" . $row['picture'] . "' class='card-img-top' alt='...'>
                ...
                <a href='update.php?id=" . $row['pet_id'] . "'><button class='btn btn-primary btn-sm' type='button'>Edit</button></a>
                <a style='display: {$style}' href='delete.php?id=" . $row['pet_id'] . "'><button class='btn btn-danger btn-sm'  type='button'>Delete</button></a>
            </div>
        </div>
    </div>";
    };
...
<div class="hero p-4 mb-3 text-center">
    <img class="userImage" src="../pictures/Mimiadmin.png" alt="picadmin">
